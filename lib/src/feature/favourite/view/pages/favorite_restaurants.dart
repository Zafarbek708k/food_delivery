...
class _FavoriteRestaurantsPageState extends State<FavoriteRestaurantsPage> {
  List<RestaurantItem> items = [
    RestaurantItem(
      isFavorited: true,
      imageUrl:
          "https://www.grozny-inform.ru/LoadedImages/2022/05/11/840px-McDonalds-exterior_2_w900_h600.jpg",
      title: "McDonald's",
    ...
    RestaurantItem(
      isFavorited: true,
      imageUrl:
          "https://media.wired.com/photos/65e71a8e4f6303aec3b5018d/1:1/w_2667,h_2667,c_limit/gettyimages-921740490.jpg",
      title: "KFC",
